...
export const enDict: Record<string, string> = {
    ...
    'agentPreset.title': 'Agent preset',
    'agentPreset.off': 'Preset: off',
    'agentPreset.loading': 'Loading presets…',
    'agentPreset.loadError': 'Failed to load presets',
    'agentPreset.defaultBadge': 'default',
    'agentPreset.empty': 'No presets available',
    'agentPreset.tooltip': 'DeepSeek agent preset (mirrors DSH harness) — full tool catalog (shell + web search, etc.)',
    'input.shortcutHint': '⏎ Send · Shift⏎ New line · {mod}K Palette',
    'input.pendingQueued': '{n} message(s) queued — will send after this turn',
    'input.sendFailedRestored': 'Send failed — restored to the input box, please retry',
    ...
    'msg.copyText': 'Copy',
    'msg.copied': 'Copied!',
    'msg.queued': 'Queued — not sent yet',
