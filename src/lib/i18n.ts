...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'provider.webSearchFallback.title': '联网搜索兜底模型',
    'provider.webSearchFallback.desc': '请求携带 web_search 服务端工具时，自动转发到该端点执行搜索（整个搜索会话将路由至此端点）。',
    'provider.webSearchFallback.enable': '启用兜底转发',
    'provider.webSearchFallback.baseUrl': 'API 端点',
    'provider.webSearchFallback.baseUrlPlaceholder': 'https://api.deepseek.com/anthropic',
    'provider.webSearchFallback.apiKey': 'API Key',
    'provider.webSearchFallback.apiKeyPlaceholder': '输入 API Key…',
    'provider.webSearchFallback.envVar': '环境变量名（二选一）',
    'provider.webSearchFallback.envVarHint': '与 API Key 二选一（留空使用上方 Key）。变量在 Little Claude 进程环境中读取。',
    'provider.webSearchFallback.model': '模型（可留空）',
    'provider.webSearchFallback.modelHint': '留空则沿用主提供商模型。',
    'provider.webSearchFallback.modelPlaceholder': 'deepseek-v4-flash',
    'provider.webSearchFallback.toolNameHint': '代理会自动将工具名改写为 web_search_20250305 以兼容 DeepSeek 等端点；主提供商不支持服务端搜索时也无需担心。',
    'provider.webSearchFallback.needActive': '请先选择或新建一个提供商。',
    'provider.webSearchFallback.test': '测试连接',
    'provider.webSearchFallback.testNoKey': '环境变量模式下测试不可用，请直接发送消息验证。',
  ...
  en: {
    ...
    'provider.webSearchFallback.title': 'Web Search Fallback Model',
    'provider.webSearchFallback.desc': 'When a request carries the web_search server tool, it is routed to this endpoint (the whole search session follows).',
    'provider.webSearchFallback.enable': 'Enable fallback routing',
    'provider.webSearchFallback.baseUrl': 'Endpoint',
    'provider.webSearchFallback.baseUrlPlaceholder': 'https://api.deepseek.com/anthropic',
    'provider.webSearchFallback.apiKey': 'API Key',
    'provider.webSearchFallback.apiKeyPlaceholder': 'Enter API Key…',
    'provider.webSearchFallback.envVar': 'Env var name (either/or)',
    'provider.webSearchFallback.envVarHint': 'Either this or the API key (empty to use the key above). Read from the Little Claude process environment.',
    'provider.webSearchFallback.model': 'Model (optional)',
    'provider.webSearchFallback.modelHint': 'Leave empty to use the main provider model.',
    'provider.webSearchFallback.modelPlaceholder': 'deepseek-v4-flash',
    'provider.webSearchFallback.toolNameHint': 'The proxy rewrites the tool name to web_search_20250305 for DeepSeek-compatible endpoints; the main provider does not need server-side search support.',
    'provider.webSearchFallback.needActive': 'Select or create a provider first.',
    'provider.webSearchFallback.test': 'Test Connection',
    'provider.webSearchFallback.testNoKey': 'Testing is unavailable in env-var mode — send a message to verify.',
