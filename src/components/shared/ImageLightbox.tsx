...
// Perf: the store moved to stores/lightboxStore.ts so hot-path consumers
// (MessageBubble / MarkdownRenderer) no longer pull in this component
// module. Re-exported for existing import sites.
