...
import { loadSkillTranslationConfigAsync } from '../../lib/skill-translation-storage';
import { MarkdownRenderer } from '../shared/MarkdownRenderer';
import { FileIcon } from '../shared/FileIcon';
import { littleClaudeTheme, littleClaudeHighlight } from '../../lib/codemirror-theme';
      ...
      <div className="flex-1 overflow-hidden">
        {isLoadingContent ? (
          ...
          <CodeMirror
            ...
            extensions={[...(Array.isArray(langExtension) ? langExtension : [langExtension]), EditorView.lineWrapping, littleClaudeHighlight]}
            theme={littleClaudeTheme}
